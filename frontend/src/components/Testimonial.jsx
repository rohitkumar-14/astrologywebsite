...
const Testimonial = () => {
  return (
    <>
      <section className="as_about_wrapper as_padderTop80 as_padderBottom80" id="testimonial"> 
        <div className="container">
          <div className="row">
            <div className="col-lg-12 col-md-12 text-center">
              <h1 className="as_heading">What My Client Say</h1>
              <span>
                <img
                ...
                <div className="carousel-inner">
                  <div className="carousel-item active" data-bs-interval="3000">
                    <div className="as_customer_box text-center">
                      <div className="as_customer_img mt-3">
                        <img
                          src={c1}
                          alt=""
                      ...
                      <h3>
                        A. Dennett - <span>Astrologer</span>
                      </h3>
                    </div>
                  </div>
                  ...
                  <div className="carousel-item" data-bs-interval="3000">
                    <div className="as_customer_box text-center">
                      ...
                      <h3>
                        David Parker - <span>Astrologer</span>
                      </h3>
                    </div>
                  </div>
                </div>
