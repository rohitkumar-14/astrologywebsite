...
const Gallery = () => {
  const [images, setImages] = useState([
    "https://www.deepakjoshiastrology.com/assets/images/award-thumb/about-1.jpg",
    "https://www.deepakjoshiastrology.com/assets/images/award-thumb/about-2.jpg",
    "https://www.deepakjoshiastrology.com/assets/images/award-thumb/about-3.jpg",
  ]);

  return (
    <>
      <div className="col-lg-12 col-md-12 text-center">
        <h1 className="as_heading">Gallery</h1>
        <span>
          <img
      ...
      <div className="container py-5">
        <div className="grid-wrapper col py-5">
          {images.map((image, index) => (
            <div className="lc-block" key={index}>
              <img
                className="img-fluid rounded galleryImg"
                src={image}
                width={"100%"}
                height={"100%"}
                loading="lazy"
